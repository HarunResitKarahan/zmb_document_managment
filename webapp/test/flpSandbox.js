		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#commarturzmbdocumentmanagment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commarturzmbdocumentmanagment-display": {
								"semanticObject": "commarturzmbdocumentmanagment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.martur.zmbdocumentmanagment",
									"url": sap.ui.require.toUrl("com/martur/zmbdocumentmanagment")
								}
							}
						}
					}
